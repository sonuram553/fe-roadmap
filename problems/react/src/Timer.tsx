...
export const Timer = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 p-8 max-w-xs mx-auto mt-20 border border-gray-200 rounded-xl shadow-md">
      <input
        className="w-full px-3 py-2 border border-gray-300 rounded-lg text-base outline-none focus:border-indigo-500 transition-colors"
        type="text"
        ref={inputRef}
        placeholder="Seconds"
      />
